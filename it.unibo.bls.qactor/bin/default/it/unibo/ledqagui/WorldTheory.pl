%==============================================
% WorldTheory.pl for actor ledqagui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledqagui).	%%old version (deprecated)
actorobj(qatuledqagui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledqagui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledqagui" ). 
...
%-------------------------------------------------
%  User static rules about ledqagui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
