%==============================================
% WorldTheory.pl for actor controlqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrolqa).	%%old version (deprecated)
actorobj(qatucontrolqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controlqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controlqa" ). 
...
%-------------------------------------------------
%  User static rules about controlqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
