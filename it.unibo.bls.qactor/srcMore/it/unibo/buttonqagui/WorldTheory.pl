%==============================================
% WorldTheory.pl for actor buttonqagui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttonqagui).	%%old version (deprecated)
actorobj(qatubuttonqagui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttonqagui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttonqagui" ). 
...
%-------------------------------------------------
%  User static rules about buttonqagui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
