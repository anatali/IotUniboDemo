%==============================================
% WorldTheory.pl for actor buttonqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttonqa).	%%old version (deprecated)
actorobj(qatubuttonqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttonqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttonqa" ). 
...
%-------------------------------------------------
%  User static rules about buttonqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
