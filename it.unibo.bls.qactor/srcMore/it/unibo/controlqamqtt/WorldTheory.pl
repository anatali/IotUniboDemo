%==============================================
% WorldTheory.pl for actor controlqamqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrolqamqtt).	%%old version (deprecated)
actorobj(qatucontrolqamqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controlqamqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controlqamqtt" ). 
...
%-------------------------------------------------
%  User static rules about controlqamqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
