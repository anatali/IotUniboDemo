%==============================================
% WorldTheory.pl for actor buttonqamqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatubuttonqamqtt).	%%old version (deprecated)
actorobj(qatubuttonqamqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor buttonqamqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of buttonqamqtt" ). 
...
%-------------------------------------------------
%  User static rules about buttonqamqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
