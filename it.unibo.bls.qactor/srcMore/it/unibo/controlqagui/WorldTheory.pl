%==============================================
% WorldTheory.pl for actor controlqagui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrolqagui).	%%old version (deprecated)
actorobj(qatucontrolqagui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controlqagui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controlqagui" ). 
...
%-------------------------------------------------
%  User static rules about controlqagui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
