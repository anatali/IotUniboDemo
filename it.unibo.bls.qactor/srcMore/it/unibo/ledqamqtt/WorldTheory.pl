%==============================================
% WorldTheory.pl for actor ledqamqtt
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledqamqtt).	%%old version (deprecated)
actorobj(qatuledqamqtt).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledqamqtt
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledqamqtt" ). 
...
%-------------------------------------------------
%  User static rules about ledqamqtt
%------------------------------------------------- 
/*
------------------------------------------------------------------------
